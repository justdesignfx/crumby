    ...
    <PageTransition>
      <main className={s.about}>
        ...
        <section className={cn(s.extravaganza, "flex-center-y")}>
          ...
          <p>
            Our rice cakes aren't just ordinary; they're flavor-packed bites of joy. We've curated a collection of
            flavors that'll make your taste buds tango. It's snacking with a side of entertainment!
          </p>
          <h3>OUR GOAL ?</h3>
