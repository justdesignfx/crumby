    ...
    <main className={s.detailProduct}>
      <section className={s.info}>
        ...
        <div className={s.desc}>
          ...
          <p>
            Imagine the delightful sound of a crispy rice cake meeting the smooth embrace of rich milk chocolate and the
      ...
      <section className={s.share}>
        ...
        <div className={s.text}>
          ...
          <p>
            Crumby is so good that you might want to keep it all to yourself. But we won't judge if you decide to share
            the Crumby love with your friends and family. Just be prepared for them to come back for more – Crumby tends
